    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide ">
          <div class="card-bg">
            <a href="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?q=80&w=1200&auto=format&fit=crop" class="" data-fancybox="gallery">
...
<section>
  ...
  <div class="pt-0 pt-md-5" style="background-color: #1f2e35;">
    <div class="row mx-md-5 pe-md-5 pt-md-5 mx-4 pt-5">
      <div class="col-12 col-md-6">
        <div class="row">
          <div class="col-12">
      ...
      <div class="col-12 col-md-6 text-c-white">
        <div>
        ...
        <div class="mt-5">
        <h4>Lovisa Bergstrom</h4>
        <p>Torben spearheads our team, shaping designs that seamlessly blend aesthetics and functionality. Their leadership sets the tone for an environment where creativity flourishes.</p>
        </div>
        <div class="mt-5">
        <h4>Henrik Larsgaard</h4>
        <p>Torben spearheads our team, shaping designs that seamlessly blend aesthetics and functionality. Their leadership sets the tone for an environment where creativity flourishes.</p>
        </div>
      </div>
      <div class="my-5 py-3">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="sec_Swiper ">
            <a href="assets/img/tt.jpg" class="" data-fancybox="gallery2">
