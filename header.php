...
<div id="navbar_head" class="bar-warp container-fluid">
  <nav  class="navbar navbar-expand-lg px-5">
    <!-- Logo -->
    <a href="" class="navbar-brand fw-bold">uncode</a>
    <!-- Toggle -->
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width: 70%;">
      ...
      <div class="offcanvas-body gap-4 justify-content-between align-items-center">
